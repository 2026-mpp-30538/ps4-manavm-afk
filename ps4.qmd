...
run_scraper = False  # REMINDER TO SET TO TRUE TO RUN, SET TO FALSE BEFORE SUBMITTING
...
```{python}
# 1. Filter: Start with ONLY "Criminal and Civil Actions"
# We use .copy() to ensure we don't get a "SettingWithCopy" warning
df_criminal = df[df['Category'] == "Criminal and Civil Actions"].copy()

# 2. Define the classification function
# We check the title for keywords to assign one of the 5 topics
